...
## Examples
We show a few examples of this package and its API below.
...
-opt_out$value # maximum lower bound value
logLik(fit) # maximum likelihood from lme4
